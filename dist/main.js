...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _API_Function__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./API_Function */ "./src/app/API_Function.js");
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Icon */ "./src/app/Icon.js");
...
const view = {
  ...
  getDOM(data) {
    ...
    const iconElement = _Icon__WEBPACK_IMPORTED_MODULE_1__["default"].get(data.icon);
    weatherIcon.innerHTML = iconElement;
    if (_API_Function__WEBPACK_IMPORTED_MODULE_0__["default"].ATTEMP === 1) {
...
const getUnit = (location) => {
  temperatureMetric.addEventListener('click', async () => {
    if (_app_API_Function__WEBPACK_IMPORTED_MODULE_1__["default"].ATTEMP === 1) { _app_API_Function__WEBPACK_IMPORTED_MODULE_1__["default"].ATTEMP++; } else { _app_API_Function__WEBPACK_IMPORTED_MODULE_1__["default"].ATTEMP--; }
    _app_DOM__WEBPACK_IMPORTED_MODULE_0__["default"].getDOM(await _app_API_Function__WEBPACK_IMPORTED_MODULE_1__["default"].getData(location));
  });
};
// DEFAULT WEATHER DATA
const defaultData = async () => {
  _app_DOM__WEBPACK_IMPORTED_MODULE_0__["default"].getDOM(await _app_API_Function__WEBPACK_IMPORTED_MODULE_1__["default"].getData('Ha Noi'));
};
